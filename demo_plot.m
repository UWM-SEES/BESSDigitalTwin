...
% added code to initialize scenario labels.
training_data_dir = "F:\data\training";
DTInfo.initialize_scenario_labels(training_data_dir);


for demo_scenario_filename = all_fault_abcg()   % TODO: Change this function for different plots
...
function [filenames] = all_fault_ab(event_index)
  ...
  filenames = [...
    sprintf("F:/data/training/Fault 1 Location 2/scenario_%d-2.mat", event_index), ...
    sprintf("F:/data/training/Fault 1 Location 3/scenario_%d-13.mat", event_index), ...
    sprintf("F:/data/training/Fault 1 Location 4/scenario_%d-125.mat", event_index), ...
    sprintf("F:/data/training/Fault 1 Location 5/scenario_%d-88.mat", event_index), ...
    sprintf("F:/data/training/Fault 1 Location 6/scenario_%d-51.mat", event_index), ...
  ];
end
...
function [filenames] = all_fault_abcg(event_index)
  ...
  filenames = [...
    sprintf("F:/data/training/Fault 10 Location 2/scenario_%d-11.mat", event_index), ...
    sprintf("F:/data/training/Fault 10 Location 3/scenario_%d-22.mat", event_index), ...
    sprintf("F:/data/training/Fault 10 Location 4/scenario_%d-134.mat", event_index), ...
    sprintf("F:/data/training/Fault 10 Location 5/scenario_%d-97.mat", event_index), ...
    sprintf("F:/data/training/Fault 10 Location 6/scenario_%d-60.mat", event_index), ...
  ];
end
